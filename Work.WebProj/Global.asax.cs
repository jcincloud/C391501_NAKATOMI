...
namespace DotWeb.AppStart
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Application_Start()
        {
            ...
            {
                ContextCondition = (Context => (Context.Request.UserAgent.Contains("MSIE 8.0")))
            });
            //DisplayModeProvider.Instance.Modes.Insert(0, new DefaultDisplayMode("en-US")
            //{
            //    ContextCondition = (C => C.Request.Cookies[VarCookie + ".Lang"] != null && C.Request.Cookies[VarCookie + ".Lang"].Value.Contains("en"))
            //});
            //DisplayModeProvider.Instance.Modes.Insert(0, new DefaultDisplayMode("ja-JP")
            //{
            //    ContextCondition = (C => C.Request.Cookies[VarCookie + ".Lang"] != null && C.Request.Cookies[VarCookie + ".Lang"].Value.Contains("ja"))
            //});
        }
