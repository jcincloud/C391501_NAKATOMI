	...
	render:function(){
		return (
				...
				<tr>
					...
					<td className="text-center">{moment(this.props.itemData.start_day).format('YYYY-MM-DD')}</td>
					...
					<td className="text-center">{this.props.itemData.lang_memo}</td>
				</tr>
			);
		}
});
...
var GirdForm = React.createClass({
	...
	handleSubmit: function(e) {
		...
		if(this.state.edit_type==1){
			...
			this.state.fieldData.introduction = CKEDITOR.instances.editor1.getData();
	...
	render: function() {
						...
						<table>
							<thead>
								<tr>
									...
									<th className="col-xs-5 text-center">標題</th>
									<th className="col-xs-1 text-center">
											日期
									</th>
									<th className="col-xs-1 text-center">									
		...
		else if(this.state.edit_type==1 || this.state.edit_type==2)
		{
			...
			var partial;
			if (fieldData.is_interval) {
				partial=(
				<div className="form-group has-feedback">
					<label className="col-xs-1 control-label">日期</label>
					<div className="col-xs-2">
						<InputDate id="start_day" name="start_day" onChange={this.changeFDValue} value={this.state.fieldData.start_day} />
						<i className="fa-calendar form-control-feedback"></i>
					</div>
					<label className="col-xs-1 text-center">~</label>
					<div className="col-xs-2">
						<InputDate id="end_day" name="end_day" onChange={this.changeFDValue} value={this.state.fieldData.end_day} />
						<i className="fa-calendar form-control-feedback"></i>
					</div>
				</div>
					);
			...
			outHtml=(<div>
					...
					<form className="form-horizontal" onSubmit={this.handleSubmit}>
						...
						<div className="form-group">
						<label className="col-xs-1 control-label">日期設定</label>
							<div className="col-xs-3">
								<div className="radio-inline">
									<label>
										...
										name="is_interval"
										value={true}
										checked={fieldData.is_interval===true} 
										onChange={this.changeFDValue.bind(this,'is_interval')}
										/>
										<span>區間日期</span>
									</label>
								</div>
								<div className="radio-inline">
									<label>
										...
										name="is_interval"
										value={false}
										checked={fieldData.is_interval===false} 
										onChange={this.changeFDValue.bind(this,'is_interval')}
										/>
										<span>單日日期</span>
									</label>
					...
					<div className="form-group">
						...
						<div className="form-group">
							...
							<div className="col-xs-8">
								<textarea  id="editor1" className="form-control" rows="10"
								value={fieldData.introduction}
								onChange={this.changeFDValue.bind(this,'introduction')} />
							</div>
						</div>
