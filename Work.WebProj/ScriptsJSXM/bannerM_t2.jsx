...
var GirdForm = React.createClass({
	...
	insertType:function(){
		this.setState({edit_type:1,fieldData:{i_Lang:'zh-TW',type:2}});
	},
		...
		else if(this.state.edit_type==1 || this.state.edit_type==2)
		{
			...
			outHtml=(<div>
					...
					<div className="alert alert-warning">
		           		<p>1.未上傳圖片時,將 <strong className="text-danger">不會顯示在前台</strong>。</p>
                	</div>
					...
					<div className="form-group">
						...
						<small className="help-inline col-xs-5 text-danger">限 1 張圖片，檔案大小限制 5MB(5000KB)，建議尺寸 1300x550 px</small>
					</div>
						...
						<div className="form-group">
							...
							<small className="help-inline col-xs-5">最多50字</small>
						</div>
